        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          <div className="sm:max-w-lg">
            ...
            <p className="mt-4 text-xl text-gray-500">
              HealthGPT provides out-of-the-box Ai tools for Chat Health
              Assistance Topics, CHAT. We hope you enjoy your stay and find the
              platform useful. Oh ya, checkout our upcoming events with Hearty!
            </p>
          </div>
          <div>
            <div className="my-10">
